...
public class InfoCommand extends BukkitCommand<Player> {
    ...
    @AllArgsConstructor public enum Guide {
        ...
        BOOSTER(
                "\n" + " " +
                "\n   §fБустеры в зависимости от процента, " +
        ...
        TOKEN(
                "\n" + " " +
                "\n   §fТокены - это одна из валют режима," +
        ...
        MONEY(
                "\n" + " " +
                "\n   §6Деньги §f- это одна из валют режима," +
        ...
        GAME(
                "\n" + " " +
                "\n   §eOpPrison §f- неклассический кликер в тюремном стиле с шахтами, " +
